...
| `rancher_server_version` | *1.5.1* | `rancher:server` | *x.x.x (with no leading `v`)* |
...
| `rancher_compose_version` | *0.12.3* | `rancher:compose` | *x.x.x (with no leading `v`)* |
| `rancher_cli_version` | *0.5.0* | `rancher:cli` | *x.x.x (with no leading `v`)* |
